作者：杨波，赵耀辉(z184321)
 ...
 代码简介：
    ...
    octahedron.py 简介：
    {
        ...
        >>程序运行必要的文件：
            “POSCAR_O1”、“POSCAR_A1”、“POSCAR_B1”、“POSCAR_C1”、“POSCAR_D1”、“POSCAR_E1”、“POSCAR_F1”、“POSCAR_I1”，原始正方体晶粒的输入文件。
            “octahedron.py”，程序运行的python脚本。

        >>程序生成文件介绍：
            在程序完成计算后，会生成“0POSCAR_O”、“0POSCAR_A”、“0POSCAR_B”、“0POSCAR_C”、“0POSCAR_D”、“0POSCAR_E”、“0POSCAR_F”、“0POSCAR_I”文件，即截取后的正八面体晶粒。
    }
    ...
    Truncated1.py 简介：
    {
        ...
        >>程序运行必要的文件：
            “0POSCAR_O”、“0POSCAR_A”、“0POSCAR_B”、“0POSCAR_C”、“0POSCAR_D”、“0POSCAR_E”、“0POSCAR_F”、“0POSCAR_I”，由 octahedron.py 生成的正八面体晶粒文件。
            “Truncated1.py”，程序运行的python脚本。

        >>程序生成文件介绍：
            在程序完成计算后，会生成“POSCAR_O”、“POSCAR_A”、“POSCAR_B”、“POSCAR_C”、“POSCAR_D”、“POSCAR_E”、“POSCAR_F”、“POSCAR_I”文件，即截角正八面体晶粒。
    }
    ...
    Kelvin1.py 简介：
    {
        ...
        >>程序运行必要的文件：
            “POSCAR_O”、“POSCAR_A”、“POSCAR_B”、“POSCAR_C”、“POSCAR_D”、“POSCAR_E”、“POSCAR_F”、“POSCAR_I”，由 Truncated1.py 生成的截角八面体晶粒文件。
            “Kelvin1.py”，程序运行的python脚本。

        >>程序生成文件介绍：
            在程序完成计算后，会生成“Extended_Kelvin_Structure_CustomPositions.vasp”文件，即最终的多晶模型 POSCAR 文件。
    }
